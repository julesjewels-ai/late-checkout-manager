...
def create_extension_request(
    ...
    # Validate that requested time is strictly after original checkout
    # Ensure both are offset-aware for comparison (SQLite sometimes drops timezone)
    ...
    price_quote = calculate_extension_price(
        original_checkout=orig_checkout,  # type: ignore
