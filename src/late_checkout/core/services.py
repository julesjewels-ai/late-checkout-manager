...
def calculate_price_quote(
    ...
    # Base rate of $20 + $10 for every hour (or fraction thereof)
    duration = requested_time - original_checkout
    hours = duration.total_seconds() / 3600

    # Calculate fractional hours correctly, min 1 hour charge if any extension made
    hours_chargeable = math.ceil(hours)

    return 20.0 + (10.0 * hours_chargeable)
...
def create_extension_request(
    ...
    # Validate requested time and calculate price
